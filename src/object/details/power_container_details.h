...
/**
 * \file object/details/power_container_details.h
...
struct CObjectPowerContainerDetails
{
    ...
    float clamp        = 100.0f;
    float dim_a        = 0.0f; // dimensions of the battery (according to y)
    float dim_b        = 0.0f; // dimensions of the battery (according to y)
