...
DriveType CLevelHardcodeCollection::GetDriveType(ObjectType type)
{
    switch(type)
    {
...
ToolType CLevelHardcodeCollection::GetToolType(ObjectType type)
{
    switch (type)
    {
        case OBJECT_MOBILEwa:
...
bool CLevelHardcodeCollection::IsObjectQuickLost(ObjectType type)
{
