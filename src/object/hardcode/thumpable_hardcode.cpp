...
bool CThumpableHardcodeCollection::IsThumpable(ObjectType type)
{
...
float CThumpableHardcodeCollection::GetThumpDurationMin(ObjectType type)
{
    if (type == OBJECT_ANT)    return 0.8f;
    if (type == OBJECT_SPIDER) return 0.8f;
    return 0.0f;
}
float CThumpableHardcodeCollection::GetThumpDurationMax(ObjectType type)
{
