...
{
    return GetObjectLevelDetails(type).drive;
}

ToolType GetToolType(ObjectType type)
{
     return GetObjectLevelDetails(type).tool;

}

bool IsObjectQuickLost(ObjectType type)
{
     return GetObjectLevelDetails(type).quickLost;
}
