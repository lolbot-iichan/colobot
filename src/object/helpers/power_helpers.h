...
// TODO: avoid direct setting, Decrease/Charge is better
void SetObjectEnergy(CObject* object, float level);
void SetObjectEnergyLevel(CObject* object, float level);
